...
namespace Soor.RopeGenerator
{
    public class Rope
    {
        ...
        private GameObject SpawnRopeSegment(int segmentIndex)
        {
            ...
            var rb = newRopeSegment.GetComponent<Rigidbody>();
        ...
        {
            var previousBody = _ropeParent.transform
                .Find((_ropeParent.transform.childCount - 1).ToString()).GetComponent<Rigidbody>();

            Object.DestroyImmediate(segment.GetComponent<CharacterJoint>());
            ...
            {
                positionSpring = _ropeData.bendingStiffness,
                positionDamper = _ropeData.bendingDamper,
