...
namespace Soor.RopeGenerator.Editor
{
    public class RopeEditorWindow : EditorWindow
    {
        ...
        private void GetRopeDataFromScriptabelObject()
        {
            ...
            _ropeData.bendingStiffness = _ropeDataScriptableObject.ropeData.bendingStiffness;
            _ropeData.bendingDamper = _ropeDataScriptableObject.ropeData.bendingDamper;
        }
        ...
        private void SerializeRopeData()
        {
            ...
            _ropeData.bendingStiffness = EditorGUILayout.FloatField("Bending Stiffness", _ropeData.bendingStiffness);
            _ropeData.bendingDamper = EditorGUILayout.FloatField("Bending Damper", _ropeData.bendingDamper);
        }
        ...
        private void SaveThisRopeDataToCurrentScriptableObject()
        {
            ...
            _ropeDataScriptableObject.ropeData.bendingStiffness = _ropeData.bendingStiffness;
            _ropeDataScriptableObject.ropeData.bendingDamper = _ropeData.bendingDamper;
        }
